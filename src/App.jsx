...
function StatsScreen({ user, username, onBack }) {
  ...
  return (
    <div style={root}>
      <div style={NOISE}/>
      <div style={{position:"relative",zIndex:1,flex:1,display:"flex",flexDirection:"column",padding:"28px 24px",overflowY:"auto",WebkitOverflowScrolling:"touch"}}>
        <BackBtn onClick={onBack}/>

        <div style={{marginBottom:28}}>
          <div style={{fontFamily:BB,fontSize:38,letterSpacing:5,lineHeight:1,color:C.white}}>{username}</div>
          <div style={{fontFamily:BC,fontSize:12,color:C.muted,letterSpacing:4,marginTop:8,fontWeight:600}}>Training Stats</div>
        </div>

...
const C = {
  ...
  amber:"#d4a053", copper:"#c47a4e", slate:"#8b9eb0",
...
export { LOGO, C, BB, BC, R, AM_TRICKS, OPEN_REGULAR, OPEN_TOP16, COMPS, CPU_CFG, haptic, CPU_NAMES };
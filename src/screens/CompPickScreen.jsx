            ...
            return (
              <div key={comp.key} style={{marginBottom:8,opacity:isSoon?0.4:1}}>
                <button className="tap" onClick={()=>!isSoon&&setExpandedComp(isOpen?null:comp.key)} style={{
                  ...
                  {comp.banner && <img src={comp.banner} alt="" style={{position:"absolute",right:0,top:0,height:"100%",objectFit:"contain",objectPosition:"right center",opacity:0.45,pointerEvents:"none"}}/>}

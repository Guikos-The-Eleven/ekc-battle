...
export default function HomeScreen({ user, username, isGuest, homeStats, setMode, setScreen, setDrillSource, goToAuth, handleSignOut, setFeedbackText, setFeedbackSent }) {
  const modeCards = [
    {key:"cpu",   label:"BATTLE",     desc:"1v1 vs CPU",          color:C.blue1,   available:true},
    {key:"drill", label:"DRILL",      desc:"Train your tricks",   color:C.blue2, available:true},
    {key:"tournament", label:"TOURNEY", desc:"Bracket competition", color:C.blue3, available:true},
    {key:"2p",    label:"2 PLAYER",   desc:"Local head to head",  color:C.blue4,   available:true},
  ];

      ...
      <div className="pop" onClick={e=>e.stopPropagation()} style={{
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          {info.lines.map((line,i)=>(
            <div key={i} style={{
              fontFamily:BC,fontSize:15,color:col,fontWeight:600,lineHeight:1.6,
              letterSpacing:1,paddingLeft:14,borderLeft:`2px solid ${C.border}`,
            }}>{line}</div>
          ))}
        </div>
